...
def calculate_cluster_metrics(true_labels, predictions, model_details, features):
    ...
    for clustering and save them to a json file along with the model details. Since we now 
    the ground truth for the clusters, classifier metrics will also be calculated.'''
    ...
    calculate_classifier_metrics(true_labels, predictions, model_details)
