...
# If the scraped text from the previous time only contains the headline and description of the article, 
# then the article wasn't correctly scrapped the first time.  
